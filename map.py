...
#dictonary with countries
countries = {'AD':[42.546245, 1.601554, "Andorra"],
...
#map init
map = folium.Map(location=[52.132633, 5.291266], zoom_start = 3, tiles = "Mapbox Bright")
breakCondition = False

while True:
    print("Give me a country code to add to your map! (or 'x' to end): ")
    country = input()
    if country == "x":
        break
    elif country not in countries:
        print("I can't find this country! Wanna check again? :)")
    else:
        latitude = countries[country][0]
        longtitude = countries[country][1]
        countryName = countries[country][2]

        # Add marker for the country visited by the user
        fg = folium.FeatureGroup(name = "My map")
        fg.add_child(folium.Marker(location=[latitude, longtitude], popup = countryName))
        map.add_child(fg)

print("Goodbye. Your map is saved!")
map.save("Map1.html")
